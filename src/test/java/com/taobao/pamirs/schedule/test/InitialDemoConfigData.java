...
public class InitialDemoConfigData extends UnitilsJUnit4 {
	...
	public void initialConfigData() throws Exception {
		...
		baseTaskType.setTaskParameter("AREA=HANGZHOU,YEAR>30");
		...
		log.info("创建调度任务成功baseTaskType success:" + baseTaskType.toString());
		...
		log.info("创建调度策略成功strategy success:" + strategy.toString());
